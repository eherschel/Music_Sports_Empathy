---
title: "MLM Preliminary Analysis"
...
```
The data for pryant_percent, baseage, and wasi_vci (the continuous variables being included in the model) appear relatively normal.
...
anova(m4, m5)
# not sing, dont include baseline age
...
Summary:
Our model suggests that the having a music or sports extracurricular activity did not significantly impact empathy within children based on participation through ages 6-12 in music or sports programs, after controlling for verbal ability. The model shows a significant effect of increasing age on empathy, regardless of group, when holding constant individuals’ verbal ability (fixed effect coefficient = 0.029, CI [0.012, 0.045]; random slope variance = 0.002); that is, participants significantly improved on their empathy scores increased about 0.029 per year when controlling for individual differences in verbal ability. When including individuals’ verbal ability as a covariate of no interest, there isn’t a significant interaction between group and time (group X time interaction coefficient for Music = -0.013, CI [-0.036, 0.011]; Sports coefficient = -0.005, CI [-0.028, 0.018]). The effect of the covariate of verbal ability on empathy was also not significant (fixed effect coefficient = 0.002, CI [-0.0002, 0.003]), when holding constant the other variables.